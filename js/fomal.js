...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Peter🥝")[0];
}
...
function createtime1() {
  var grt = new Date("09/26/202t 00:00:00"); //此处修改你的建站时间或者网站上线时间
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   ______     | || |  _________   | || |  _________   | || |  _________   | || |  _______     | |
| |  |_   __ \   | || | |_   ___  |  | || | |  _   _  |  | || | |_   ___  |  | || | |_   __ \    | |
| |    | |__) |  | || |   | |_  \_|  | || | |_/ | | \_|  | || |   | |_  \_|  | || |   | |__) |   | |
| |    |  ___/   | || |   |  _|  _   | || |     | |      | || |   |  _|  _   | || |   |  __ /    | |
| |   _| |_      | || |  _| |___/ |  | || |    _| |_     | || |  _| |___/ |  | || |  _| |  \ \_  | |
| |  |_____|     | || | |_________|  | || |   |_____|    | || | |_________|  | || | |____| |___| | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'                 
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Peter🥝 %c 你正在访问Peter🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Peter🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Peter🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("9/26/2025 00:00:00");
